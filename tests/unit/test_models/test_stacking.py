...
class TestStackingEnsemble:
    ...
    def test_no_label_leakage_in_stacking(self, mock_lstm_predictions, mock_lightgbm_predictions):
    ...
    def test_ensemble_with_different_meta_learners(self):
        ...
        for meta_cls in [LogisticRegression, RidgeClassifier]:
            ...
            meta.fit(stacked, y)
            proba = meta.predict_proba(stacked) if hasattr(meta, 'predict_proba') else None
