...
Bản báo cáo được triển khai theo khung chuẩn đồ án tốt nghiệp:

1. **Mở đầu** trình bày tính cấp thiết, lý do chọn đề tài, mục tiêu, đối tượng và phạm vi, phương pháp nghiên cứu, ý nghĩa và cấu trúc luận văn.
2. **Chương 1 (Tổng quan)** trình bày bối cảnh, động cơ chọn XAU/USD, bài toán nghiên cứu, câu hỏi nghiên cứu, mục tiêu, phạm vi, đóng góp và cấu trúc luận văn.
3. **Chương 2 (Cơ sở lí luận và công nghệ)** trình bày nền tảng học thuật: đặc tính dữ liệu tài chính, phân tích kỹ thuật dưới góc nhìn thống kê, triple-barrier labeling, walk-forward validation, purge/embargo, các mô hình học máy, metrics, SHAP và rủi ro backtest overfitting.
4. **Chương 3 (Dữ liệu và phương pháp)** trình bày dữ liệu và pipeline: nguồn, biến OHLCV, múi giờ, kiểm tra chất lượng, feature engineering causal, whitelist feature, gán nhãn, phân phối nhãn và thiết kế pipeline 6 stage.
5. **Chương 4 (Thực nghiệm và kết quả)** trình bày kết quả: môi trường, cấu hình, so sánh mô hình, metrics, confusion matrix, high-confidence, backtest demo, phân tích lỗi và hạn chế.
6. **Chương 5 (Minh họa ứng dụng)** trình bày cách chuyển tín hiệu dự báo thành hành động giao dịch, giả định thực thi, kết quả backtest và điều kiện triển khai thực tế.
7. **Chương 6 (Kết luận và kiến nghị)** tóm tắt đóng góp, kết quả thực nghiệm, hạn chế, hướng phát triển và thông điệp bảo vệ.
...
- [ ] Chương 4 dùng số liệu thật mới nhất.
- [ ] Chương 5 nói rõ backtest là demo.
