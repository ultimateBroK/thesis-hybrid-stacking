...
Public API surface only.  Runners and helpers live in ``_runners.py``,
strategy in ``_strategy.py``, persistence/stats in ``_persistence.py``.
...
from thesis.stage_5_backtest._persistence import (
...
from thesis.stage_5_backtest._runners import (
    _make_commission_fn,
    _prepare_df,
    _run_bt,
)
from thesis.stage_5_backtest._strategy import (
