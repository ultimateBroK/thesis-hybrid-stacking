...
- ``thesis._shared`` — configuration, constants (including ``timeframe_to_ms()``), session paths, UI helpers, zones
...
- ``thesis.dashboard`` — Streamlit dashboard (10 modules, launched via shim)
